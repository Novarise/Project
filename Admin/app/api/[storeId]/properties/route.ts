...
export async function POST(request: Request, { params }: { params: { storeId: string } }) {
    ...
    try {
        ...
        const PropertyDoc = await Property.findOne({ userId, storeId: params.storeId })
            .then((result) => {
                if (!result) {
...
export async function GET(request: Request, { params }: { params: { storeId: string } }) {
    ...
    try {
        ...
        const PropertyDoc = await Property.findOne({ userId: userId, storeId: params.storeId })
...
export async function DELETE(request: Request, { params }: { params: { storeId: string } }) {
    try {
        ...
        const query = { userId: userId, storeId: params.storeId, 'properties._id': propertyID };
