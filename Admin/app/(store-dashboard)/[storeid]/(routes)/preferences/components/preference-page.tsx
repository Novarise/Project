...
interface PreferencesPageProp {
    storeData: any, billboardData: any, formattedCategories:any, formattedProperties: any
};

const PreferencePage: FC<PreferencesPageProp> = ({ storeData, billboardData, formattedCategories, formattedProperties }) => {
                ...
                <div className="flex-col">
                    <div className="flex-1 space-y-4 p-8 pt-6">
                        ...
                        <CategoriesClient data={formattedCategories} 
                                            initialData={null} billboards={billboardData}
                        />
                    </div>
                </div>
            </TabsContent>
