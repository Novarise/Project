  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {billboards.map((item) => (
          <div
            onClick={() => handleEditBillboard(item)}
          ...
          >
            ...
            <a className="text-sm">{item.createdAt}</a>
          </div>
        ))}
      </div>
