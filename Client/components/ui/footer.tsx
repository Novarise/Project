      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-5 gap-10">
        <div>
          ...
          <div className="flex space-x-4 mt-4">
            <Link
              href="#"
              className="dark:hover:text-gray-700 hover:text-gray-300"
            >
              <Facebook />
            </Link>
            <Link
        ...
        <div className="flex flex-col gap-2">
          ...
          <Link
            href="/about"
            className="text-md dark:hover:text-gray-700 hover:text-gray-300"
          >
            Coffee
          </Link>
          <Link
      ...
      <div className="flex items-center justify-center mt-8 ">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-44 bg-gray-200 dark:bg-gray-800 rounded-md">
          <div className=" rounded-md  ">
            <span className="flex text-sm mr-2 p-2">
