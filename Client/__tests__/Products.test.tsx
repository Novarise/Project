...
describe('getServerSideProps', () => {
    it('fetches successfully data from an API', async () => {
            const data = {
                    StoreDoc: {
                        ...
                        activeBillboard: {
                            ...
                            imageUrl: 'https://novarise-billboards-upload.s3.amazonaws.com/Untitled%20design.png',
                            categories: [],
            ...
            expect(axios.get).toHaveBeenCalledWith(expect.any(String), { headers: { 'Cache-Control': 'no-cache' } });
        });
